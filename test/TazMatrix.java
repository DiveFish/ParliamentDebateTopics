...
public class TazMatrix implements TermDocumentMatrix {
    ...
    /**
     *
     * @param sectionIDs The ids of the single sections in the article
     * @param articleContent The article content
     * @throws IOException
     */
    public void processFile(List<String> sectionIDs, List<List<Token>> articleContent) throws IOException {
        for (List<Token> articleSection : articleContent) {
            
            String fileID = sectionIDs.get(articleContent.indexOf(articleSection));
            ...
            for (Integer token : tokensToIndices(articleSection)) {
