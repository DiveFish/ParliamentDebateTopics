...
public class MatrixBuilderLa4j {
    ...
    public static void main(String[] args) throws IOException, TreeTaggerException {
        ...
        TermDocMatrixLa4j termDocMatrix = new TermDocMatrixLa4j(layer, vocabulary.documentIndices(),
        ...
        SparseMatrix tdfIdfMatrix = termDocMatrix.tfIdf(termDocumentMatrix);
        System.out.println("Visualizing td.idf matrix");
        System.out.println(tdfIdfMatrix);
